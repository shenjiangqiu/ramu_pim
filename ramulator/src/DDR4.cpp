...
void DDR4::init_speed() {
  ...
  speed_entry.nFAW = FAW_TABLE[org_entry.dq == 4   ? 0
                               : org_entry.dq == 8 ? 1
                                                   : 2][speed];
...
// string DDR4::cmd_to_str(DDR4::Command &cmd) {
//   switch (cmd) {
//   case DDR4::Command::ACT:
//     return "ACT";
//   case DDR4::Command::PRE:
//     return "PRE";
//   case DDR4::Command::PREA:
//     return "PREA";
//   case DDR4::Command::RD:
//     return "RD";
//   case DDR4::Command::WR:
//     return "WR";
//   case DDR4::Command::RDA:
//     return "RDA";
//   case DDR4::Command::WRA:
//     return "WRA";
//   case DDR4::Command::REF:
//     return "REF";
//   case DDR4::Command::PDE:
//     return "PDE";
//   case DDR4::Command::PDX:
//     return "PDX";
//   case DDR4::Command::SRE:
//     return "SRE";
//   case DDR4::Command::SRX:
//     return "SRX";
//   }
// }
...
void DDR4::init_timing() {
  ...
  t[int(Command::WRA)].push_back(
      {Command::REF, 1, s.nCWL + s.nBL + s.nWR + s.nRP});
